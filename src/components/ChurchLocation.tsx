...
export function ChurchLocation() {
  return (
    <section className="w-full max-w-6xl mx-auto px-4 py-8 md:py-12">
      ...
      <Card className="w-full bg-white/70 backdrop-blur-lg shadow-xl border border-gray-300 overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-6 space-y-4">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-lg sm:text-xl font-semibold">
                <FaMapMarkedAlt className="text-neutral-900" />{" "}
                {churchLocation.name}
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-sm sm:text-base md:text-lg">
              ...
              <p className="flex items-center gap-2 text-gray-700">
                ...
                <strong>Telefone:</strong> {churchLocation.phone}
              </p>

              <p className="flex items-center gap-2 text-gray-700">
                <FaEnvelope className="text-neutral-900" />{" "}
                <strong>Email:</strong> {churchLocation.email}
              </p>
              ...
              <div>
                ...
                <ul className="text-gray-700 space-y-1">
                  <li>
                    ...
                    {churchLocation.serviceHours.sunday.join(" e ")}
                  </li>
                  <li>
                    <strong>Terça:</strong>{" "}
                    {churchLocation.serviceHours.tuesday}
                  </li>
                  <li>
                    <strong>Quinta:</strong>{" "}
                    {churchLocation.serviceHours.thursday}
                  </li>
                  <li>
                    <strong>3º Sábado:</strong>{" "}
                    {churchLocation.serviceHours.thirdSaturday}
                  </li>
                </ul>
              </div>
